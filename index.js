...
client.once('ready', async () => {
	...
	console.log('Code by MG STUDIO!');
	console.log('discord.gg/MG STUDIO');

    // Load all server invites1166772582951964702
...
client.on('guildMemberAdd', async member => {
    ...
    const welcomeEmbed = new Discord.MessageEmbed()
        ...
        .addFields(
            ...
            { name: 'Server Rules', value: '<#1236216985646268501>.', inline: true },
            { name: 'Support Channel', value: '<#1236610382722760704>.', inline: true }
        )
    ...
    const row = new MessageActionRow()
        .addComponents(
            new MessageButton()
                .setStyle('LINK')
                .setURL('https://youtube.com/@x_youssef_1234?si=GGGHitbUt2AxGfHQ')       // link to button 1
                .setLabel('YouTube')                                 // name of button 1
                .setEmoji('<:Youtubee:1241353323064463471>'),       // emoji of button 1
            new MessageButton()
                .setStyle('LINK')
                .setURL('https://github.com/YousssfMG2024')           // link to button 2
                .setLabel('GitHub')                               // name of button 2
                .setEmoji('<:Github:1241349047621652542>'),      // emoji of button 2
            new MessageButton()
                .setStyle('LINK')
                .setURL('https://x.com/Youssef75018361?t=WDoFaaEcHDGjTsDXScVEjQ&s=09')                // link to button 3
                .setLabel('TWITTER')                          // name of button 3
                .setEmoji('<:emoji_50:1241355655592415232>')      // emoji of button 3
        );
